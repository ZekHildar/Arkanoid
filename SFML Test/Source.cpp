/*int main()
{
    ...
    RenderWindow app(VideoMode(1008, 630), "Arkanoid!");
    ...
    while (app.isOpen())
    {
        ...
        if (Keyboard::isKeyPressed(Keyboard::Up)) sPaddle.move(0, -10);
        if (Keyboard::isKeyPressed(Keyboard::Down)) sPaddle.move(0, 10);
